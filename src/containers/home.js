...
class Home extends React.Component {
  ...
  open = (id) => {
    ...
    this.setState({
      showDialog: true,
      productId: id,
      productUrl: 'http://35.226.194.192:3000/pdp?productId=' + id
    });
  }
        ...
        <div className="container-fluid" style={{ backgroundImage: "url(" + BackgroundImg + ")", backgroundRepeat: "" }}>
          ...
          <div className="row">
            <div className="col-lg-12 product-carousel">
              ...
              <Dialog aria-label="" isOpen={this.state.showDialog} onDismiss={this.close} style={{ marginTop: '50vh', width: '80em', height: 'auto' }}>
